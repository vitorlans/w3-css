...
ดาวน์โหลด Repo นี้และนำไฟล์ **w3.css** หรือไฟล์อื่นๆ ที่ต้องการนำไปใช้ ไปใส่ในโปรเจกต์ที่ต้องการ หากจะทำผ่าน Terminal ให้ ```cd``` ไปที่โฟลเดอร์ของ Project ของท่าน และใช้คำสั่ง
